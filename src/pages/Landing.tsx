  ...
  return (
    <section className="relative isolate h-screen w-full bg-[#0a1a33] text-white font-poppins overflow-hidden">
      <div className="relative z-10 flex h-full items-center justify-center px-6">
        <div className="relative mx-auto w-[92%] md:w-[80%] lg:w-[65%] max-w-[950px]">
          <AnimatedBackground src="./src/assets/landingbg.svg" />

          <motion.img
            src="./src/assets/landingrobo.svg"
      ...
      <div className="pointer-events-auto absolute bottom-30 left-[49%] z-20 -translate-x-1/2">
